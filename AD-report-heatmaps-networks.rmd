...
#### Control male cohort
![image](images/sympt-heatmap-male-control-cohort.png)
![image](images/sympt-network-male-control-cohort.png)

#### Control female cohort
![image](images/sympt-heatmap-female-control-cohort.png)
![image](images/sympt-network-female-control-cohort.png)

#### Chronic male cohort
![image](images/sympt-heatmap-male-chronic-cohort.png)
![image](images/sympt-network-male-chronic-cohort.png)

#### Chronic female cohort
![image](images/sympt-heatmap-female-chronic-cohort.png)
![image](images/sympt-network-female-chronic-cohort.png)

#### Network differences between male chronic and control cohorts
![image](images/sympt-network-diff-male-chron-control.png)

#### Network differences between female chronic and control cohorts
![image](images/sympt-network-diff-female-chron-control.png)

#### Network differences between female and male chronic cohorts
![image](images/sympt-network-diff-female-male-chron.png)
...
![image](images/sympt-heatmap-misdiagnosed-male.png)
![image](images/sympt-network-misdiagnosed-male.png)

### Correct diagnosis in females
![image](images/sympt-heatmap-misdiagnosed-female.png)
![image](images/sympt-network-misdiagnosed-female.png)
...
![image](images/sympt-network-diff-mdx-cdx-males.png)

### Difference in mis- and correct diagnosis in females
![image](images/sympt-network-diff-mdx-cdx-females.png)

### Difference in misdiagnosis between females and males
![image](images/sympt-network-diff-mdx-males-females.png)

# AD co-occurence

## AD co-occurence with ADs log2 transformed
```{r AD heat cooc, echo=FALSE}
heat_cooc_ad <- "images/AD-cooc-log2.pdf"
...
heat_cooc_ad_comorb <- "images/AD-comorb-cooc-log2.pdf"
