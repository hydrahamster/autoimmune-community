...
label(data$autoimmune_id___15)="What autoimmune disease (or diseases) have you been formally diagnosed with? Please select all that apply. If your condition is not in the list, select other and specify.  (choice=Guillain Barré syndrome)"
...
label(data$autoimmune_id___38)="What autoimmune disease (or diseases) have you been formally diagnosed with? Please select all that apply. If your condition is not in the list, select other and specify.  (choice=Sjögrens syndrome)"
